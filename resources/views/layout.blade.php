...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- DiscountMaster -->
            <li class="nav-item">
                <a class="nav-link @if(!request()->is('admin/discount*')) collapsed @endif" href="#" data-toggle="collapse" data-target="#DiscountMaster"
                    aria-expanded="true" aria-controls="collapseTwo">
                    <i class="fas fa-fw fa-box"></i>
                    <span>Discounts</span>
                </a>
                <div id="DiscountMaster" class="collapse @if(request()->is('admin/discount*')) show @endif" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{url('admin/discount/create')}}">Add New</a>
                        <a class="collapse-item" href="{{url('admin/discount')}}">View All</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="StaffMaster" class="collapse @if(request()->is('admin/staff*')) show @endif" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{url('admin/viewmanageStaff')}}">view Manage Staff</a>
                    </div>
                </div>
            </li>
